...
class GoodsType(BaseModel):
    ...
    image = models.ImageField(upload_to='static/images/upload', verbose_name='商品类型图片')
...
class GoodsSKU(BaseModel):
    ...
    image = models.ImageField(upload_to='static/images/goods', verbose_name='商品图片')
...
class GoodsImage(BaseModel):
    ...
    image = models.ImageField(upload_to='static/images/goods', verbose_name='图片路径')
...
class IndexGoodsBanner(BaseModel):
    '''首页轮播商品展示模型类'''
    sku = models.ForeignKey('GoodsSKU', verbose_name='商品', on_delete=models.CASCADE)
    image = models.ImageField(upload_to='static/images/banner', verbose_name='图片')
...
class IndexPromotionBanner(BaseModel):
    ...
    image = models.ImageField(upload_to='static/images/banner', verbose_name='活动图片')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
